...
for(ftr in ftrsToPlot){
  partDepPlot_bovee(
    ...
    x.var=ftr,
    plot=TRUE, main = ftr, barPlotYlim = c(0,6), linePlotYlim = c(0,6)
  )
}
...
for(ftr in ftrsToPlot){
  partDepPlot_bovee(
    ...
    x.var=ftr,
    plot=TRUE, main = ftr, barPlotYlim = c(0, 1.5), linePlotYlim = c(0,1.5)
  )
}
...
for(ftr in ftrsToPlot){
  partDepPlot_bovee(
    ...
    x.var=ftr,
    plot=TRUE, main = ftr, barPlotYlim = c(0, 40), linePlotYlim = c(0,40)
  )
}
