...
RFdata = data.frame(RFdata, stringsAsFactors=FALSE)
table(RFdata[,'SS18_Persistence'], factor(RFdata[,'SS18_Persistence']), useNA='always')
...
#7.28.19
# mod = randomForest(factor(SS18_Persistence) ~ . , data=RFdata, type='classification', importance=TRUE)
# 
# partialPlot(mod, pred.data=RFdata, x.var='FEMALE')
# head(RFdata)
